    ...
    return (
      <footer>
        <div className="group">
          ...
          <ul>
            <li><a href="https://vikitTech.github.io/mcore-vue/#/documents/quick-start" rel="noopener noreferrer" target="_blank">mcore Vue</a> - mcore of Vue</li>
        ...
        <div className="group">
          ...
          <ul>
            ...
            <li>
              <a href="https://app.mokahr.com/apply/vikit/320" rel="noopener noreferrer" target="_blank">
        ...
        <div className="group">
          ...
          <ul>
            <li><a href="https://github.com/vikitTech/mcore" rel="noopener noreferrer" target="_blank">Github</a></li>
            <li>
            ...
            <li>
              <a href="https://github.com/vikitTech/mcore/issues/new" rel="noopener noreferrer" target="_blank">
                <FormattedMessage id="app.home.footer.help.bug-report" />
              </a>
            </li>
            <li>
              <a href="https://github.com/vikitTech/mcore/issues" rel="noopener noreferrer" target="_blank">
                <FormattedMessage id="app.home.footer.help.bug-list" />
              </a>
            </li>
            <li>
              <a href="https://gitter.im/vikitTech/mcore" rel="noopener noreferrer" target="_blank">

...
describe('Collapse', () => {
  ...
  it('renders correctly with defaultActiveKey and activeKey', () => {
    ...
    expect(wrapper.find('.mcore-collapse-item--active').length).toBe(1);
  });
  ...
  it('click collapse item correctly', () => {
    ...
    wrapper.find('.mcore-collapse-item__title').at(0).simulate('click');
  ...
  it('active item toggle correctly with animated', (done) => {
    ...
    wrapper.find('.mcore-collapse-item__title').at(0).simulate('click');
    setTimeout(() => {
      expect(wrapper.find('.mcore-collapse-item--active').length).toBe(0);
      done();
    }, 0);
  });
  ...
  it('click should not trigger callback without key', () => {
    ...
    wrapper.find('.mcore-collapse-item__title').simulate('click');
    expect(props.onChange).not.toBeCalled();
  });
});

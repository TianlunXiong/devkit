...
describe('DatePicker', () => {
  ...
  //     />
  //   );
  //   expect(wrapper.find('.mcore-popup__wrapper')).to.have.lengthOf(1);
  ...
  it('should trigger onOk when press ok button', () => {
    ...
    wrapper.find('.mcore-date-picker__submit').simulate('click');
  ...
  it('should trigger onCancel when press cancel button', () => {
    ...
    wrapper.find('.mcore-date-picker__cancel').simulate('click');

...
describe('Picker', () => {
  ...
  it('should trigger onOk when press ok button', () => {
    ...
    wrapper.find('.mcore-picker__submit').simulate('click');
  ...
  it('should trigger onCancel when press cancel button', () => {
    ...
    wrapper.find('.mcore-picker__cancel').simulate('click');
  ...
  //   wrapper.find('.mcore-mask').simulate('click');
  ...
  //   wrapper.find('.mcore-picker-stack-column').at(0).simulate('click');
  //   wrapper.find('.mcore-picker-stack-item').at(0).simulate('click');
  ...
  //       />
  //   );
  //   wrapper.find('.mcore-picker-input').simulate('click');
  //   wrapper.find('.mcore-picker-cancel').simulate('click');
  //   wrapper.find('.mcore-mask').simulate('click');
  // });
});

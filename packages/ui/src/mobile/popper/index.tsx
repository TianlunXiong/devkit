    ...
    if (this.popperNode) {
      ...
      if (animationType === 'menuSlide' && placement) {
        if (placement.includes('top')) {
          return `mcore-${animationType}-down-${animationState}`;
        }
        return `mcore-${animationType}-up-${animationState}`;
      }
      return `mcore-${animationType}-${animationState}`;
    }
  }

...
describe('Radio.Group', () => {
  ...
  it('shape is radius', () => {
    ...
    expect(wrapper.find('.mcore-radio-group').hasClass('mcore-radio-group--radius')).toBe(true);
  });
  ...
  it('shape is round', () => {
    ...
    expect(wrapper.find('.mcore-radio-group').hasClass('mcore-radio-group--round')).toBe(true);
  });
  ...
  it('block', () => {
    ...
    expect(wrapper.find('.mcore-radio-group').hasClass('mcore-radio-group--block')).toBe(true);
  });
  ...
  it('type is cell', () => {
    ...
    expect(wrapper.find('.mcore-radio-group').hasClass('mcore-radio-group--cell')).toBe(true);
  });

...
describe('StackPicker', () => {
  ...
  it('handle props click', () => {
    ...
    wrapper.find('.mcore-stackpicker__submit').simulate('click');
    expect(onOk).toHaveBeenCalledWith(['340000', '340800', '340803']);

    wrapper.find('.mcore-stackpicker__cancel').simulate('click');
  ...
  it('handle onChange', () => {
    ...
    wrapper
      .find('.mcore-stackpicker__group')
      .at(0)
      .find('.mcore-stackpicker__stack-column')
      .at(0)
      .simulate('click');
    ...
    wrapper
      .find('.mcore-stackpicker__group')
      .at(0)
      .find('.mcore-stackpicker__stack-column-wrapper')
      .at(0)
      .simulate('click');
    ...
    wrapper
      ...
      .find('.mcore-stackpicker__stack-column-wrapper')
      .at(0)
      .find('.mcore-stackpicker__stack-column-item')
      .at(0)
      .simulate('click');

...
const activeIcon = (
  <div style={{
    width: '24px',
    height: '24px',
    background: 'url(//cdn-health.vikit.com/mcore/home-active.svg) top left / 24px 24px no-repeat',
  }}
  />
);
...
const icon = (
  <div style={{
    width: '24px',
    height: '24px',
    background: 'url(//cdn-health.vikit.com/mcore/home.svg) top left / 24px 24px no-repeat',
  }}
  />
);
...
describe('ActivityIndicator', () => {
  ...
  it('onChange', () => {
    ...
    wrapper.find('.mcore-tab-bar__item').first().simulate('click');
